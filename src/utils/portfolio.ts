...
export const projectsSection: ProjectsSectionType = {
  ...
  projects: [
    ...
    {
      id: getId(),
      name: 'ItalyFestivals.it',
      url: 'https://italyfestivals.it/',
      repo: 'https://github.com/melissadeleonx  ',
      img: '/italy-festivals.png',
      alt: "Find the best feast and Festivals in Italy",
      year: 2023,
      tags: ['HTML', 'CSS', 'JavaScript'],
    },
    {
      id: getId(),
      name: 'SicilyShortStay.com',
      url: '/',
      repo: 'https://github.com/melissadeleonx  ',
      img: '/sicilyshortstay-image.png',
      alt: "Sicily Short Stay",
      year: 2023,
      tags: ['HTML', 'CSS', 'JavaScript'],
    },
    {
